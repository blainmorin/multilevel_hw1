...
$$  Level 2 : \alpha_j \sim \mathcal{N}(\mu + \gamma_0Treat + \gamma_1Age, \tau^2) $$
...
Graphically, we see that there is not much difference between the red and blue lines. Thus, there is not much difference in the partial pooling. 

# Q3 GH Chapter 12: Exercise 4
